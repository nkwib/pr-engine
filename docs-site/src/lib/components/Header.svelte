<script>
  ...
  const links = [
    ...
    { href: '/decisions', label: 'Invariants' }
  ];
...
<header class="header">
  <div class="inner">
    <a href="/" class="brand" aria-label="prcompass core home">
      <Logo />
      <span class="version" aria-hidden="true">core · v0.1</span>
    </a>
    ...
    <div class="actions">
      <a
        class="gh"
        href="https://github.com/nkwib/prcompass-core"
        target="_blank"
        rel="noopener"
